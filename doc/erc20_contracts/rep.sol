...
//此合约代码从Augur github获取  
//地址  : https://github.com/AugurProject/augur-core/tree/master/source/contracts/legacy_reputation
...
contract LegacyRepToken is Initializable, PausableToken {
    // ERC20Basic public legacyReputationToken = address(0x0);
    ...
    //去掉多余限制
    function LegacyRepToken( ) {
        //require(_legacyReputationToken != 0);
        //legacyReputationToken = ERC20Basic(_legacyReputationToken);
        totalSupply = 10 * (10**8) * (10**18);//legacyReputationToken.totalSupply();
