    ...
    <hit-container>
      <div class="recharge-record-box">
        ...
        <el-table border :data="depositList" style="margin: 0px;width: 100%">
          <el-table-column prop="token_name" label="订单号" align="center" :resizable="false"></el-table-column>
          <el-table-column prop="token_name" label="币种" align="center" :resizable="false"></el-table-column>
          <el-table-column prop="token_name" label="数量" align="center" :resizable="false"></el-table-column>
          ...
          <el-table-column prop="token_name" label="提币时间" align="center" :resizable="false"></el-table-column>
          <el-table-column prop="token_name" label="完成时间" align="center" :resizable="false"></el-table-column>
          <el-table-column prop="token_name" label="备注" align="center" :resizable="false"></el-table-column>
        </el-table>
        <el-pagination
