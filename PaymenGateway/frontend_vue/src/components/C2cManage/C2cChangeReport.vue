    ...
    <hit-container>
      <div class="recharge-record-box">
        ...
        <el-table border :data="depositList" style="margin: 0px;width: 100%">
          ...
          <el-table-column prop="token_name" label="时间" align="center" :resizable="false"></el-table-column>
          <el-table-column prop="token_name" label="当天买卖差额" align="center" :resizable="false"></el-table-column>
          <el-table-column prop="token_name" label="当日买入数量" align="center" :resizable="false"></el-table-column>
          <el-table-column prop="token_name" label="当日卖出数量" align="center" :resizable="false"></el-table-column>
          <el-table-column prop="token_name" label="当日买入笔数" align="center" :resizable="false"></el-table-column>
          <el-table-column prop="token_name" label="当日卖出笔数" align="center" :resizable="false"></el-table-column>
          <el-table-column prop="token_name" label="交易总数量" align="center" :resizable="false"></el-table-column>
          <el-table-column prop="token_name" label="交易总笔数" align="center" :resizable="false"></el-table-column>
        </el-table>
        <el-pagination
