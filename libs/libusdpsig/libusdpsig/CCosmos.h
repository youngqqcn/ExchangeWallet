...
#define  UINT_MAX_FEE_AMOUNT	(10000)		//最大交易手续费
#define  UINT_MIN_FEE_AMOUNT	(100)			//最大交易手续费
#define  UINT_MAX_GAS_AMOUNT	(200000000) //最大gas
#define  UINT_MIN_GAS_AMOUNT	(200000)		//最大gas
...
struct CsRawTx
{
	...
	//gas_price 和  GasPrice   ===>  this->uFeeAmount
	//gas_wanted 和  GasWanted ===>  this->uGas
