...
void MakeRealSig()
{
	...
	csRawTx.uAccountNumber = 12;
	strcpy_s(csRawTx.szChainId, STR_MAINCHAIN);
	strcpy_s(csRawTx.szFeeDenom, "satoshi");
	strcpy_s(csRawTx.szMemo, "");
	strcpy_s(csRawTx.szMsgDenom, "satoshi");
	strcpy_s(csRawTx.szMsgFrom, "usdp15havmvnt4ygfyfuqm32aecth7p8800f6pkf652");
	strcpy_s(csRawTx.szMsgTo, "usdp1vmsfd7rly9chhjpaalr55q5886lnva99ghlesg");
	csRawTx.uMsgAmount = 66;
	csRawTx.uGas = 200000;
...
//真实交易数据测试
void MakeTestnetSig_2020()
{
	cosmos::CsRawTx  csRawTx;
	csRawTx.uAccountNumber = 11;
	strcpy_s(csRawTx.szChainId, STR_TESTCHAIN);
	strcpy_s(csRawTx.szFeeDenom, "satoshi");
	strcpy_s(csRawTx.szMemo, "yqq");
	strcpy_s(csRawTx.szMsgDenom, "satoshi");
	strcpy_s(csRawTx.szMsgFrom, "htdf1jrh6kxrcr0fd8gfgdwna8yyr9tkt99ggmz9ja2");
	strcpy_s(csRawTx.szMsgTo, "htdf1m5phsvgrwpxdsmah5cqkvd6ffz9xzrc3e0jkr2");
	csRawTx.uMsgAmount = 12345678;
	csRawTx.uGas = 200000;
	csRawTx.uFeeAmount = 100;
	csRawTx.uSequence = 8;
	...
	std::string strOut;
	if (false == csRawTx.ToString_2020(strOut))
	{
		std::cout << "错误:" << strOut << std::endl;
		return;
	}
